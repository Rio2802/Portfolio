...
using use = useUsing("use")`,
  ...
  [SkillNames.CPP]: {
    ...
    name: "cpp",
    label: "C++",
    shortDescription: "Memory management? I hardly know her! 🧠💥",
    color: "#00599C",
  ...
  [SkillNames.SQL]: {
    ...
    name: "sql",
    label: "SQL",
    shortDescription: "SELECT * FROM life WHERE happy = true; 📊🔑",
    color: "#4479A1",
  ...
  [SkillNames.FLASK]: {
    ...
    name: "flask",
    label: "Flask",
    shortDescription: "Micro but mighty! 🌶️🔥",
    color: "#000000",
  ...
  [SkillNames.ANGULAR]: {
    ...
    name: "angular",
    label: "Angular",
    shortDescription: "The enterprise beast! 🅰️🛡️",
    color: "#DD0031",
  ...
  [SkillNames.TENSORFLOW]: {
    ...
    name: "tensorflow",
    label: "TensorFlow",
    shortDescription: "Brain power for your code! 🧠🤖",
    color: "#FF6F00",
  ...
  [SkillNames.PYTORCH]: {
    ...
    name: "pytorch",
    label: "PyTorch",
    shortDescription: "Research to production, real quick! 🔥🔬",
    color: "#EE4C2C",
